...
### Main Package for React Native Harness
...
The main entry point package that provides the CLI binary and aggregates all React Native Harness functionality, including runtime, metro integration, and babel preset.
